 ...
 * assigned to Future interface to generate the ConcurrentHashMap. All the maps
...
public class SubjectProcess {
	 ...
	 * @return BlockingQueue which holds all ConcurrentHashMaps
	 * @throws InterruptedException Exception if interrupted
	 * @throws ExecutionException   Exception during the execution process
	 */
